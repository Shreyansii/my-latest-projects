...
//         response = await api.patch(`admin/categories/${editingCategory.id}/`, submitData)
...
//       alert(`Failed to save category: ${err.response?.data?.detail || JSON.stringify(err.response?.data) || 'Unknown error'}`)
//     } finally {
//       setSubmitting(false)
//     }
//   }
