...
SECRET_KEY = 'django-insecure-n!-x&&r*-kgztx1n#^wo187sc-n9^f5zgr=1je(#79c)y9be=t'
...
SPECTACULAR_SETTINGS = {
    ...
    'SECURITY': [
        {'Bearer': []},  # Applies JWT Bearer token to all API views
    ],
    'SECURITY_DEFINITIONS': {
        'Bearer': {
            ...
            'in': 'header',
            'name': 'Authorization',
            'description': 'JWT Bearer Token: "Bearer <your_token>"'
        }
    }
}
